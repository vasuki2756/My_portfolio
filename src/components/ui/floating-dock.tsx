  ...
  return (
    <Link href={href} target={target}>
      <motion.div
        ...
        className="aspect-square rounded-full bg-gray-200 dark:bg-slate-700 flex items-center justify-center relative"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className="px-2 py-0.5 whitespace-pre rounded-md bg-gray-100 border dark:bg-slate-700 dark:border-neutral-900 dark:text-white border-gray-200 text-neutral-700 absolute left-1/2 -translate-x-1/2 -top-8 w-fit text-xs"
            >
              {title}
            </motion.div>
          )}
